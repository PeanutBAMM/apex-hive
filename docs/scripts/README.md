...
│   └── startup-context.md
├── core-scripts
│   ├── code-scripts-overview.md
│   ├── code-stub.md
│   ├── commands-reference.md
│   ├── init-project.md
│   ├── init-scripts-overview.md
│   ├── save-conversation-overview.md
│   ├── save-conversation.md
│   ├── search-scripts-overview.md
│   └── search.md
├── deployment-scripts
│   ├── build-scripts-overview.md
│   ├── build.md
│   ├── changelog-generate.md
│   ├── changelog-scripts-overview.md
│   ├── deploy-scripts-overview.md
│   ├── deploy.md
│   ├── release-scripts-overview.md
│   ├── release.md
│   ├── version-bump.md
│   └── version-scripts-overview.md
├── detection-scripts
│   ├── detect-issues-detailed.md
│   ├── detect-issues-overview.md
│   ├── detect-issues.md
│   ├── fix-detected-overview.md
│   ├── fix-detected.md
