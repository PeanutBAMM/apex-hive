...
- **Message**: 1 console.log statement found (lines: 25)
- **Fixable**: Yes - Remove console.log statements
...
- **Message**: 16 console.log statements found (lines: 12, 23, 26, 32, 51, 54, 56, 61, 65, 68, 74, 75, 77, 80, 83, 87)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/ci-fix.js:146
- **Message**: 2 console.log statements found (lines: 146, 153)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/ci-status.js:76
- **Message**: 1 console.log statement found (lines: 76)
- **Fixable**: Yes - Remove console.log statements
...
- **Message**: 2 console.log statements found (lines: 226, 235)
- **Fixable**: Yes - Remove console.log statements
...
- **Message**: 3 console.log statements found (lines: 362, 363, 367)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/fix-detected.js:221
- **Message**: 2 console.log statements found (lines: 221, 223)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/init-project.js:310
- **Message**: 2 console.log statements found (lines: 310, 312)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/quality-check.js:60
- **Message**: 2 console.log statements found (lines: 60, 61)
- **Fixable**: Yes - Remove console.log statements
...
- **Message**: 4 console.log statements found (lines: 1, 44, 45, 54)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/quality-validate.js:60
- **Message**: 8 console.log statements found (lines: 60, 72, 76, 78, 82, 84, 89, 91)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/release.js:277
- **Message**: 2 console.log statements found (lines: 277, 285)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: scripts/report-status.js:511
- **Message**: 1 console.log statement found (lines: 511)
- **Fixable**: Yes - Remove console.log statements
...
- **Message**: 2 console.log statements found (lines: 4, 5)
- **Fixable**: Yes - Remove console.log statements

### console-log
- **Category**: code
- **File**: test-mcp-protocol.js:44
- **Message**: 8 console.log statements found (lines: 44, 57, 71, 74, 81, 84, 96, 100)
- **Fixable**: Yes - Remove console.log statements
